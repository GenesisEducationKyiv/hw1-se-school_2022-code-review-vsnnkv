...
func NewNotificationController(n services.NotificationServiceInterface, l tools.LoggerInterface) *NotificationController {
	return &NotificationController{n, l}
}
